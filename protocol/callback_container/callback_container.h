...
#define INIT_CALLBACK_CONTAINER_MACRO(rT, cT)                                                                                                           \
    typedef struct {                           /*  callback container struct    */                                                                      \
        ...
        cT context;                            /*  callback context             */                                                                      \
                                                                                                                                                        ...
                                                                                                                                                        \
                                                                                                                                                        \
/* new callback container with user parameters */                                                                                                       \
TEMPLATE(CallbackContainer, rT, cT)* TEMPLATE(newCallbackContainerUser, rT, cT) (rT (*callback)(cT context), cT context, b * ok)                        \
{                                                                                                                                                       \
...
TEMPLATE(CallbackContainer, rT, cT)* TEMPLATE(newCallbackContainerHeap, rT, cT) (rT (*callback)(cT context), reg heapContextSize, b * ok)               \
{                                                                                                                                                       \
    TEMPLATE(CallbackContainer, rT, cT) * m_container = (TEMPLATE(CallbackContainer, rT, cT) *) malloc(sizeof(TEMPLATE(CallbackContainer, rT, cT)));    \
    if(m_container == NULL) {                                                                                                                           \
        *ok = 0;                                                                                                                                        \
    ...
    *ok = 1;                                                                                                                                            \
    return m_container;                                                                                                                                 \
                                                                                                                                                        ...
                                                                                                                                                        \
/* init callback container with user parameters */                                                                                                      \
b TEMPLATE(initCallbackContainerUser, rT, cT) (TEMPLATE(CallbackContainer, rT, cT)* self, rT (*callback)(cT context), cT context)                       \
{                                                                                                                                                       \
    if(self == NULL) {                                                                                                                                  \
        return 0;                                                                                                                                       \
    }                                                                                                                                                   \
...
b TEMPLATE(initCallbackContainerHeap, rT, cT) (TEMPLATE(CallbackContainer, rT, cT)* self, rT (*callback)(cT context), reg heapContextSize)              \
{                                                                                                                                                       \
    if(self == NULL) {                                                                                                                                  \
        return 0;                                                                                                                                       \
    }                                                                                                                                                   \
    ...
    return 1;                                                                                                                                           \
                                                                                                                                                        ...
                                                                                                                                                        \
/* safe calling callback container */                                                                                                                   \
rT TEMPLATE(callbackContainerCall, rT, cT) (TEMPLATE(CallbackContainer, rT, cT)* self, b * ok)                                                          \
{                                                                                                                                                       \
